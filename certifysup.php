...
<body>
	<div class="header">
    	...
    	<?php 
         $row1 = mysqli_fetch_array($certifs);
    	if ($row1=="") {
    		echo "No Entry exists to Certify";
    	} ?>
    	<?php while ($row1) { ?>

    		<form method="post" action="certifysup.php">
		   ...
		   <br/> 
			 ...
			 <div class="input-group">
			 <button type="submit" class="btn" name="certs">Certify</button>
		     </div>
               </form>
    	<?php  $row1 = mysqli_fetch_array($certifs);} ?>
